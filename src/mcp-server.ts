...
// Remove Express imports - using standard Web API types instead
...
export class SwaggerMcpServer {
  ...
  // Note: SSE handling methods removed as they're not needed for Cloudflare Workers
  // MCP Server will be accessed directly via the agent framework
}
